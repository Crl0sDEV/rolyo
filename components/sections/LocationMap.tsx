        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <p className="text-slate-600 text-lg mb-10">
              Ready na ba ang labada? Drop by our store in Cabanatuan City. We
              are conveniently located near Avida Town Center.
            </p>
            ...
            <div className="space-y-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-600 mt-1">
                    Lorenzo Bldg., Avida Town Center
                    <br />
                    Brgy. Sta. Arcadia, Along E. Emilio Vergara Hwy
                    <br />
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-600 mt-1">
                    Tawag o text para sa pickup:
                  </p>
                  <a
                    href="tel:09209274185"
                    className="text-2xl font-bold text-primary hover:text-blue-700 transition-colors block mt-1"
                  >
                    0920 927 4185
                  </a>
                </div>
