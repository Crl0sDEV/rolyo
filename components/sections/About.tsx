        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <p className="text-slate-600 text-lg mb-6 leading-relaxed">
              Nagsimula ang Rolyo Laundry Services sa simpleng layunin: ang
              bigyan ang mga taga-Cabanatuan ng labadang
              <span className="font-semibold text-slate-800">
                {" "}
                mabilis, malinis, at mabango
              </span>
              —yung parang ikaw mismo ang naglaba, pero wala nang pagod.
            </p>

            <p className="text-slate-600 text-lg mb-8 leading-relaxed">
              Gamit ang aming modernong equipment at premium detergents,
              sinisigurado namin na bawat damit na dumadaan sa amin ay
              inaalagaan nang husto. From casual wear to heavy comforters, sagot
              namin &apos;yan.
            </p>
