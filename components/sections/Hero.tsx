...
export default function Hero() {
  return (
    <section
      id="hero"
      className="relative pt-25 pb-20 lg:pt-35 lg:pb-32 overflow-hidden bg-background"
    >
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg text-muted mb-8 max-w-lg leading-relaxed">
              Experience premium laundry care with Rolyo. Mabilis, mabango, at
              siguradong malinis. We treat your clothes like our own.
            </p>
            ...
            <div className="flex items-center gap-4 text-sm text-slate-500">
              <div className="flex -space-x-3">
                {[1, 2, 3, 4].map((i) => (
                  <div
                    key={i}
                    className="w-10 h-10 rounded-full border-2 border-white bg-slate-200 relative overflow-hidden"
                  >
                    <Image
