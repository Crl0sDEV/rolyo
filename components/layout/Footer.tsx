    ...
    <footer className="bg-slate-900 text-slate-300 py-12 border-t border-slate-800">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-slate-400 max-w-sm mb-6">
              Your trusted laundry partner in Cabanatuan City. Kami ang bahala
              sa labada mo, para may time ka sa mas importanteng bagay.
            </p>
            <div className="flex gap-4">
              ...
              <a
                href="https://www.instagram.com/rolyo.laundry/"
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="#location" className="hover:text-cyan-400 transition">
                  Location
                </a>
              </li>
              <li>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-sm">
                  Lorenzo Bldg., Avida Town Center, Cabanatuan City
                </span>
              </li>
        ...
        <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-slate-500">
          <p>
            © {new Date().getFullYear()} Rolyo Laundry Services. All rights
            reserved.
          </p>
